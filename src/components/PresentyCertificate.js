...
function PresentyCertificate() {
  ...
  const monthnyear = `${now.getFullYear()}-${String(
    now.getMonth() + 1
  ).padStart(2, "0")}`;
  const endDate = new Date(now.getFullYear(), now.getMonth() + monthsToAdd, 1);
  const monthnyearend = `${endDate.getFullYear()}-${String(
    endDate.getMonth() + 1
  ).padStart(2, "0")}`;
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/academic/student-school", {
        params: {
          studentId: id,
          schoolUdiseNo: udise,
        },
          ...
          <div className="border border-dark p-2">
            ...
            <div className="row">
              ...
              <div className="col-9">
                <div className="text-center">
                  <p className="small">
                    {studentData?.school?.schoolSlogan || ""}
                  </p>
                  ...
                  <p className="small  p-0 m-0">
                    ...
                    {studentData?.school?.state?.stateName || "___"},{" "}
                  ...
                  <p className="small  border-top p-0 m-0 border-dark">
                    ...
                    {studentData?.schoolUdise?.boardIndexNo}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              <p>
                ...
                चालू वर्ष {academicData?.academicYear} मध्ये{" "}
                {academicData?.standard?.standard} मध्ये शिकत आहे.मागील शैक्षणिक{" "}
                {lastAcademicData?.academicYear} वर्ष मध्ये{" "}
                {studentData?.gender === "पुरुष" ? "त्याची" : "तिची"} उपस्थिती
                ७५% पेक्षा जास्त होती. दाखला मागणीवरुन देणेत आला असे.
              </p>
            </div>
            <div className="row">
              <div className="col-6">
                ...
                <p>
                  दिनांक :- {now.getDate()}-{now.getMonth()}-{now.getFullYear()}
                </p>
              </div>
              <div className="col-6">
                <p>मुख्याध्यापक</p>
