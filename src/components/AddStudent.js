...
const marathiYearWordsLookup = {
  1980: "एकोणीसशे ऐंशी",
  1981: "एकोणीसशे एक्याऐंशी",
  1982: "एकोणीसशे ब्याऐंशी",
  1983: "एकोणीसशे त्र्याऐंशी",
  1984: "एकोणीसशे चौऱ्याऐंशी",
  1985: "एकोणीसशे पंच्याऐंशी",
  1986: "एकोणीसशे शहाऐंशी",
  1987: "एकोणीसशे सत्याऐंशी",
  1988: "एकोणीसशे अठ्ठ्याऐंशी",
  1989: "एकोणीसशे एकोणनव्वद",
  1990: "एकोणीसशे नव्वद",
  1991: "एकोणीसशे एक्याण्णव",
  1992: "एकोणीसशे ब्याण्णव",
  1993: "एकोणीसशे त्र्याण्णव",
  1994: "एकोणीसशे चौऱ्याण्णव",
  1995: "एकोणीसशे पंच्याण्णव",
  1996: "एकोणीसशे शहाण्णव",
  1997: "एकोणीसशे सत्याण्णव",
  1998: "एकोणीसशे अठ्ठ्याण्णव",
  1999: "एकोणीसशे नव्याण्णव",
  2000: "दोन हजार",
  2001: "दोन हजार एक",
  2002: "दोन हजार दोन",
  2003: "दोन हजार तीन",
  ...
  2023: "दोन हजार तेवीस",
  2024: "दोन हजार चोवीस",
  2025: "दोन हजार पंचवीस",
  2026: "दोन हजार सव्वीस",
  2027: "दोन हजार सत्तावीस",
  2028: "दोन हजार अठ्ठावीस",
  2029: "दोन हजार एकोणतीस",
  2030: "दोन हजार तीस",
  2031: "दोन हजार एकतीस",
  2032: "दोन हजार बत्तीस",
  2033: "दोन हजार तेहतीस",
  2034: "दोन हजार चौतीस",
  2035: "दोन हजार पस्तीस",
};
...
function getMarathiDateWords(dateStr) {
  ...
  try {
    ...
    if (!dayText || !monthText || yearText === year.toString()) {
      console.warn("Could not convert date parts to Marathi", {
        day,
        month,
        year,
      });
...
function AddStudent() {
  ...
  useEffect(() => {
    ...
    if (school) {
      apiService
        .getbyid("standardmaster/getbyudise/", school)
        .then((response) => setStandards(response.data));
      apiService
        .getbyid("student/byudise/", school)
  ...
  useEffect(() => {
    if (formData.stateOfBirth) {
      const filtered = districts.filter(
        (d) => d.state.id === parseInt(formData.stateOfBirth)
      );
      setFilterDistrict(filtered);
      if (
        formData.districtOfBirth &&
        !filtered.some((d) => d.id === parseInt(formData.districtOfBirth))
      ) {
        setFormData((prev) => ({
          ...prev,
          districtOfBirth: "",
  ...
  useEffect(() => {
    if (formData.districtOfBirth) {
      const filtered = tehsils.filter(
        (t) => t.district.id === parseInt(formData.districtOfBirth)
      );
      setFilteredTehsils(filtered);
      if (
        formData.tehasilOfBirth &&
        !filtered.some((t) => t.id === parseInt(formData.tehasilOfBirth))
      ) {
        setFormData((prev) => ({
          ...prev,
          tehasilOfBirth: "",
  ...
  useEffect(() => {
    if (formData.tehasilOfBirth) {
      const filtered = villages.filter(
        (v) => v.tehsil.id === parseInt(formData.tehasilOfBirth)
      );
      setFilteredVillages(filtered);
      if (
        formData.villageOfBirth &&
        !filtered.some((v) => v.id === parseInt(formData.villageOfBirth))
      ) {
  ...
  const validateForm = useCallback(() => {
    ...
    const isTaken = (field, value) => {
      ...
      return students.some(
        (item) =>
          item[field]?.toString().trim() === value.toString().trim() &&
          item.school?.udiseNo === school
      );
    };

    // ** Registration Info **
    if (!formData.registerNumber.trim())
      newErrors.registerNumber = "नोंदणी क्रमांक आवश्यक आहे.";
    else if (!registerNumRegex.test(formData.registerNumber))
      newErrors.registerNumber = "नोंदणी क्रमांकात स्पेस नसावी.";
    else if (isTaken("registerNumber", formData.registerNumber))
      newErrors.registerNumber = "हा नोंदणी क्रमांक आधीच वापरात आहे.";

    if (formData.apparId && !apparIdRegex.test(formData.apparId))
      newErrors.apparId = "अपार आयडी १० अंकी असावा.";
    else if (formData.apparId && isTaken("apparId", formData.apparId))
      newErrors.apparId = "हा अपार आयडी आधीच अस्तित्वात आहे.";

    if (formData.studentId && !studentIdRegex.test(formData.studentId))
      newErrors.studentId = "विद्यार्थी आयडी १९ अंकी असावा.";
    else if (formData.studentId && isTaken("studentId", formData.studentId))
      newErrors.studentId = "हा विद्यार्थी आयडी आधीच अस्तित्वात आहे.";
    ...
    if (!formData.surName.trim()) newErrors.surName = "आडनाव आवश्यक आहे.";
      ...
      newErrors.surName = "आडनावात फक्त अक्षरे/स्पेस/मराठी/नुक्ते असू शकतात.";
    if (!formData.studentName.trim())
      newErrors.studentName = "विद्यार्थ्याचे नाव आवश्यक आहे.";
    else if (!nameRegex.test(formData.studentName))
      newErrors.studentName = "नावात फक्त अक्षरे/स्पेस/मराठी/नुक्ते असू शकतात.";
    if (!formData.fatherName.trim())
      newErrors.fatherName = "वडिलांचे नाव आवश्यक आहे.";
    else if (!nameRegex.test(formData.fatherName))
      newErrors.fatherName = "नावात फक्त अक्षरे/स्पेस/मराठी/नुक्ते असू शकतात.";
    if (!formData.motherName.trim())
      newErrors.motherName =
        'आईचे नाव आवश्यक आहे. आईचे नाव उपलब्ध नसल्यास "-" हे अक्षर टाइप करा';

    if (!formData.nationality.trim())
      newErrors.nationality = "राष्ट्रीयत्व आवश्यक आहे.";
    if (!formData.motherTongue.trim())
      newErrors.motherTongue = "मातृभाषा आवश्यक आहे.";
    ...
    if (!formData.residentialAddress.trim())
      newErrors.residentialAddress =
        'निवासी पत्ता आवश्यक आहे. पत्ता उपलब्ध नसल्यास "-" हे अक्षर टाइप करा ';
    if (!formData.mobileNo.trim())
      newErrors.mobileNo = "मोबाईल नंबर आवश्यक आहे.";
    else if (!mobileRegex.test(formData.mobileNo))
      newErrors.mobileNo = "मोबाईल नंबर १० अंकी असावा.";

    // ** Birth Place Info **
    if (!formData.stateOfBirth)
      newErrors.stateOfBirth = "राज्य निवडणे आवश्यक आहे.";
    if (!formData.districtOfBirth)
      newErrors.districtOfBirth = "जिल्हा निवडणे आवश्यक आहे.";
    if (!formData.tehasilOfBirth)
      newErrors.tehasilOfBirth = "तालुका निवडणे आवश्यक आहे.";
    if (!formData.villageOfBirth)
      newErrors.villageOfBirth = "गाव निवडणे आवश्यक आहे.";
    ...
    if (!formData.whichStandardAdmitted)
      newErrors.whichStandardAdmitted = "प्रवेश इयत्ता निवडणे आवश्यक आहे.";

    // ** Additional Info **
    if (formData.adhaarNumber && !adhaarRegex.test(formData.adhaarNumber))
      newErrors.adhaarNumber = "आधार कार्ड नंबर १२ अंकी असावा.";
    else if (
      formData.adhaarNumber &&
      isTaken("adhaarNumber", formData.adhaarNumber)
    )
      newErrors.adhaarNumber = "हा आधार कार्ड नंबर आधीच अस्तित्वात आहे.";
  ...
  const handleChange = (e) => {
    ...
    if (
      ...
      if (value && !isOnlyMarathi(value)) {
        currentErrors[id] =
          "कृपया केवळ मराठी भाषा वापरा. भाषा बदलण्यासाठी windows key + स्पेसबार दाबा";
      }
    }
    ...
    const checkUniqueness = (fieldId, fieldValue) => {
      ...
      return students.some(
        (item) =>
          item[fieldId]?.toString().trim() === fieldValue.toString().trim() &&
          item.school?.udiseNo === school
      );
    };
    ...
    if (id === "dateOfBirth") {
      ...
      if (birthDate > minBirthDate) {
        currentErrors.dateOfBirth =
          "विद्यार्थ्याचे वय किमान ६ वर्षे असणे आवश्यक आहे.";
      } else {
    ...
    if (id === "residentialAddress") {
      ...
      if (value && value.length < 6) {
        ...
        currentErrors.residentialAddress =
          "कृपया केवळ मराठी भाषा वापरा. भाषा बदलण्यासाठी windows key + स्पेसबार दाबा";
      }
    }
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (buttonRole === "search") {
      // Check the attribute from the button
      ...
      if (!currentRegisterNumber) {
        Swal.fire(
          "त्रुटी!",
          "माहिती शोधण्यासाठी कृपया जनरल रजिस्टर नंबर प्रविष्ट करा.",
          "error"
        );
        setErrors((prev) => ({
          ...prev,
          registerNumber: "माहिती शोधण्यासाठी आवश्यक",
        }));
      ...
      const selectedStudent = students.find(
        (student) =>
          student.registerNumber?.toString().trim() === currentRegisterNumber
      );
      ...
      if (selectedStudent) {
        ...
        studentDataForForm.stateOfBirth = selectedStudent.stateOfBirth?.id
          ? String(selectedStudent.stateOfBirth.id)
          : "";
        studentDataForForm.districtOfBirth = selectedStudent.districtOfBirth?.id
          ? String(selectedStudent.districtOfBirth.id)
          : "";
        studentDataForForm.tehasilOfBirth = selectedStudent.tehasilOfBirth?.id
          ? String(selectedStudent.tehasilOfBirth.id)
          : "";
        studentDataForForm.villageOfBirth = selectedStudent.villageOfBirth?.id
          ? String(selectedStudent.villageOfBirth.id)
          : "";

        // Handle whichStandardAdmitted - if it's an object with an id, or just a direct id or null
        if (
          selectedStudent.whichStandardAdmitted &&
          typeof selectedStudent.whichStandardAdmitted === "object" &&
          selectedStudent.whichStandardAdmitted.id
        ) {
          studentDataForForm.whichStandardAdmitted = String(
            selectedStudent.whichStandardAdmitted.id
          );
        } else if (
          selectedStudent.whichStandardAdmitted &&
        ...
        if (
          studentDataForForm.school &&
          typeof studentDataForForm.school === "object"
        ) {
        ...
        Swal.fire(
          "माहिती मिळाली!",
          "विद्यार्थ्याची माहिती फॉर्ममध्ये भरली आहे.",
          "success"
        );
        ...
        Swal.fire(
          "त्रुटी!",
          "दिलेला जनरल रजिस्टर नंबर असलेला विद्यार्थी सापडला नाही.",
          "error"
        );
        setFormData((prev) => ({
          ...initialFormData,
        ...
        setErrors((prev) => ({
          ...prev,
          registerNumber: "विद्यार्थी सापडला नाही",
        }));
      }
      setButtonRole("");
    ...
    if (buttonRole === "update") {
      try {
        ...
        let errorMsg =
          "माहिती सबमिट करताना त्रुटी आली. कृपया पुन्हा प्रयत्न करा.";
        if (error.response && error.response.data) {
          ...
          if (
            ...
            setErrors((prev) => ({
              ...prev,
              [error.response.data.field]: backendError,
            }));
          } else if (error.response.data?.registerNumber) {
            // Example check
            setErrors((prev) => ({
              ...prev,
              registerNumber: error.response.data.registerNumber,
            }));
          }
        }
          ...
          <div className="card shadow-sm border-0 rounded-3 overflow-hidden">
            ...
            <div className="card-header bg-primary bg-gradient text-white p-3 position-relative">
              ...
              <div className="d-flex justify-content-center align-items-center">
                ...
                <h3 className="mb-0 text-center fw-bold fs-3 heading-font">
            ...
            <div className="card-body p-4">
              ...
              <form onSubmit={handleSubmit} className="fs-5" noValidate>
                  ...
                  <div className="card-body p-3">
                    ...
                    <div className="row g-3">
                      ...
                      <div className="col-md-4 mb-2">
                        ...
                        <select
                          className={`form-select form-select-sm ${getValidationClass(
                            "gender"
                          )}`}
                          id="gender"
                        ...
                        {errors.gender && (
                          <div id="genderError" className="invalid-feedback">
                            {errors.gender}
                          </div>
                        )}
                      </div>
                  ...
                  <div className="card-body p-3">
                    ...
                    <div className="row g-3">
                      ...
                      <CombinedDropdownInput
                        ...
                        validationClass={getValidationClass("nationality")}
                        className="col-md-3"
                      />
                      <CombinedDropdownInput
                        id="motherTongue"
                        ...
                        validationClass={getValidationClass("motherTongue")}
                        className="col-md-3"
                      />
                      <CombinedDropdownInput
                        id="religion"
                        ...
                        validationClass={getValidationClass("religion")}
                        className="col-md-3"
                      />
                      <div className="col-md-3 mb-2">
                        <label
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          placeholder="उपजात"
                          aria-describedby="subCastError"
                        />
                        {errors.subCast && (
                          <div id="subCastError" className="invalid-feedback">
                            {errors.subCast}
                          </div>
                        )}
                      </div>
                      <CombinedDropdownInput
                        ...
                        error={errors.caste}
                        validationClass={getValidationClass("caste")}
                        className="col-md-3"
                      />
                    </div>
                  </div>
                    ...
                    <div className="row g-3">
                      <div className="col-md-6 mb-2">
                        ...
                        <input
                          ...
                          aria-describedby="birthPlaceError"
                        />
                        {errors.birthPlace && (
                          <div
                            id="birthPlaceError"
                      ...
                      <div className="col-md-6 mb-2">
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          required
                          aria-describedby="stateOfBirthError"
                        >
                      ...
                      <div className="col-md-4 mb-2">
                        ...
                        <select
                          ...
                          required
                          aria-describedby="districtOfBirthError"
                        >
                        ...
                        {errors.districtOfBirth && (
                          <div
                            id="districtOfBirthError"
                            className="invalid-feedback"
                          >
                            {errors.districtOfBirth}
                          </div>
                      ...
                      <div className="col-md-4 mb-2">
                        ...
                        <select
                          ...
                          required
                          aria-describedby="tehasilOfBirthError"
                        >
                        ...
                        {errors.tehasilOfBirth && (
                          <div
                            id="tehasilOfBirthError"
                            className="invalid-feedback"
                          >
                            {errors.tehasilOfBirth}
                          </div>
                      ...
                      <div className="col-md-4 mb-2">
                        ...
                        <select
                          ...
                          required
                          aria-describedby="villageOfBirthError"
                        >
                        ...
                        {errors.villageOfBirth && (
                          <div
                            id="villageOfBirthError"
                            className="invalid-feedback"
                          >
                            {errors.villageOfBirth}
                          </div>
                      ...
                      <div className="col-md-6 mb-2">
                        ...
                        <input
                          ...
                          readOnly
                          placeholder="उदा. बारा जानेवारी दोन हजार तीन"
                          aria-describedby="dateOfBirthInWordError"
                        />
                ...
                <div className="card mb-4 border-0 bg-light">
                  <div className="card-body p-3">
                    ...
                    <div className="row g-3">
                      <div className="col-md-4 mb-2">
                        <label
                          htmlFor="lastSchoolUdiseNo"
                          className="form-label fw-semibold small"
                        >
                          मागील शाळेचा UDISE नंबर
                        </label>
                        <input
                          type="text"
                          className="form-control form-control-sm"
                      ...
                      <div className="col-md-4 mb-2">
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          required
                          aria-describedby="admissionDateError"
                        />
                        {errors.admissionDate && (
                          <div
                            id="admissionDateError"
                            className="invalid-feedback"
                          >
                            {errors.admissionDate}
                          </div>
                      ...
                      <div className="col-md-4 mb-2">
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          required
                          aria-describedby="whichStandardAdmittedError"
                        >
                        ...
                        {errors.whichStandardAdmitted && (
                          <div
                            id="whichStandardAdmittedError"
                            className="invalid-feedback"
                          >
                            {errors.whichStandardAdmitted}
                          </div>
                ...
                <div className="card mb-5 border-0 bg-light">
                  {" "}
                  {/* Added mb-5 for spacing before button */}
                  <div className="card-body p-3">
                    <h5 className="card-title border-bottom pb-2 mb-3 fs-5 fw-bold">
                    ...
                    <div className="row g-3">
                      <div className="col-md-6 mb-2">
                        ...
                        <textarea
                          ...
                          aria-describedby="residentialAddressError"
                        />
                        {errors.residentialAddress && (
                          <div
                            id="residentialAddressError"
                            className="invalid-feedback"
                          >
                            {errors.residentialAddress}
                          </div>
                      ...
                      <div className="col-md-6 mb-2">
                        ...
                        />
                        {errors.mobileNo ? (
                          <div id="mobileNoError" className="invalid-feedback">
                            {errors.mobileNo}
                          </div>
                        ) : (
                          <small className="text-muted d-block mt-1">
                            १० अंकी नंबर प्रविष्ट करा
                          </small>
                        )}
                      </div>
                    </div>
                ...
                <div className="d-flex justify-content-center mt-4 gap-5">
                  ...
                  <button
                    type="submit"
                    className="btn btn-secondary btn-lg px-5 py-2 rounded-pill shadow-sm"
                    onClick={() => {
                      setButtonRole("search");
                    }}
                  >
                    <BiSearch />
                    शोधा व बदल करा
                  ...
                  <span
                    className="btn btn-danger btn-lg px-5 py-2 rounded-pill shadow-sm"
                    onClick={() => {
                      sessionStorage.removeItem(STORAGE_KEY);
                      setFormData((prev) => ({ ...initialFormData }));
                    }}
