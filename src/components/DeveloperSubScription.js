    ...
    const handlePasswordSubmit = () => {
        ...
        setTimeout(() => {
            if (password === DEVELOPER_PASSWORD) {
                setIsAuthenticated(true); // Switch to the subscription page
            } else {
                ...
                <div className="col-11 col-sm-8 col-md-6 col-lg-4 col-xl-3">
                    <div className="card border-secondary shadow-lg">
                        ...
                        <div className="card-body p-4">
                            <p className="text-center text-white-50">Enter the password to proceed.</p>
                            <div className="mb-3">
                                ...
                                />
                                {passwordError && (
                                    <div className="invalid-feedback mt-2 text-center">{passwordError}</div>
                                )}
                            </div>
                            ...
                            >
                                {isLoading ? (
                                    <><LoaderCircle size={20} className="me-2 spinner-border spinner-border-sm" /> Validating...</>
                                ) : 'Continue'}
                            </button>
                        </div>
                    </div>
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-8 col-xl-7">
                        <div className="alert alert-success d-flex align-items-center alert-dismissible fade show shadow-sm">
                            ...
                            <div><strong>Access Granted!</strong> Set the subscription date below.</div>
                            <button type="button" className="btn-close" onClick={handleGoBackToLogin}></button>
                        </div>

                        <form onSubmit={handleSubscriptionSubmit} className="card border-0 shadow-lg">
                            <div className="card-header bg-primary bg-gradient text-white p-4">
                                <h3 className="card-title mb-0 fw-bold">Set Subscription Date</h3>
                            </div>

                            <div className="card-body p-4 p-md-5">
                                <div className="row g-3">
                                    <div className="col-12">
                                        <label htmlFor="accountExpiryDate" className="form-label fw-bold text-muted">Subscription End Date *</label>
                                        <div className="input-group">
                                            {/* 4. Corrected Icon */}
                                            <span className="input-group-text"><CalendarDays size={18} /></span>
                                            <input
                                                type="date"
                                ...
                                <div className="d-flex justify-content-between align-items-center">
                                    <button type="button" className="btn btn-secondary" onClick={handleGoBackToLogin}>
                                        <ArrowLeft size={16} className="me-1" /> Back to Login
                                    </button>
                                    <button type="submit" className="btn btn-primary px-4 ms-2 bg-gradient">
